...
namespace CSCourseML.Model
{
    public class ModelInput
    {
        ...
        public ModelInput(string vendor_id, float rate_code, float passenger_count, float trip_time_in_secs, float trip_distance, string payment_type)
        {
            Vendor_id = vendor_id;
            Rate_code = rate_code;
