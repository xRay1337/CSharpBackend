...
namespace CSCourseML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\zlovi\source\repos\CSCourse\CSCourseML.Model\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"C:\Users\zlovi\AppData\Local\Temp\MLVSTools\CSCourseML\CSCourseML.Model\MLModel.zip";
